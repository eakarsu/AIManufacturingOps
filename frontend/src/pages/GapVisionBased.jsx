...
// Vision Based
// Vision-based quality inspection (defect classification from camera feed)
...
export default function GapVisionBased() {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 960, margin: '0 auto' }}>
      ...
      <p style={{ color: '#555', marginBottom: 20 }}>Vision-based quality inspection (defect classification from camera feed)</p>
