...
// Nested
// Nested routes structure (everything is monolithic in index.js)

export default function GapNested() {
  ...
  const runAnalysis = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-nested', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 960, margin: '0 auto' }}>
      <h1 style={{ fontSize: 28, marginBottom: 6 }}>Nested</h1>
      <p style={{ color: '#555', marginBottom: 20 }}>Nested routes structure (everything is monolithic in index.js)</p>
