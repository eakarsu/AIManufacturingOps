...
// Streaming
// Streaming OEE anomaly detection with auto-ticket creation
...
export default function GapStreaming() {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 960, margin: '0 auto' }}>
      ...
      <p style={{ color: '#555', marginBottom: 20 }}>Streaming OEE anomaly detection with auto-ticket creation</p>
