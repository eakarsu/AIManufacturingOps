...
// Agentic
// Agentic production planner balancing throughput, energy, maintenance windows
...
export default function GapAgentic() {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 960, margin: '0 auto' }}>
      ...
      <p style={{ color: '#555', marginBottom: 20 }}>Agentic production planner balancing throughput, energy, maintenance windows</p>
