...
// Digital
// Digital twin sandbox for what-if scheduling

export default function GapDigital() {
  ...
  const runAnalysis = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-digital', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 960, margin: '0 auto' }}>
      <h1 style={{ fontSize: 28, marginBottom: 6 }}>Digital</h1>
      <p style={{ color: '#555', marginBottom: 20 }}>Digital twin sandbox for what-if scheduling</p>
