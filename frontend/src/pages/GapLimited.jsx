...
// Limited
// Limited RBAC (role enforcement minimal)

export default function GapLimited() {
  ...
  const runAnalysis = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-limited', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 960, margin: '0 auto' }}>
      <h1 style={{ fontSize: 28, marginBottom: 6 }}>Limited</h1>
      <p style={{ color: '#555', marginBottom: 20 }}>Limited RBAC (role enforcement minimal)</p>
