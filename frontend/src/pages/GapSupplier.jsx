...
// Supplier
// Supplier risk monitoring with auto-failover suggestions

export default function GapSupplier() {
  ...
  const runAnalysis = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-supplier', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 960, margin: '0 auto' }}>
      <h1 style={{ fontSize: 28, marginBottom: 6 }}>Supplier</h1>
      <p style={{ color: '#555', marginBottom: 20 }}>Supplier risk monitoring with auto-failover suggestions</p>
